...
export const POST: APIRoute = async ({ request, cookies, redirect }) => {
  ...
  if (error) {
    console.error('[admin/etudes/supprimer] error:', error.message);
    return redirect('/dashboard/admin/etudes?error=' + encodeURIComponent('Impossible de supprimer ce formulaire.'));
  }
